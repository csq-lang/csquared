 ...
 * @details Defines all node types, operators, and data structures used to represent
 * the parsed program structure. Provides interfaces for AST node creation and manipulation.
 */
 ...
 * @details Categorizes all possible AST node types representing different language constructs
 * from program structure to expressions and statements.
 */
typedef enum {

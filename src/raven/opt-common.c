...
typedef int (*option_handler)(const char *arg, int idx, int argc, char** argv, csq_options* opts);
...
static int handle_debug_lexer(const char *arg, int idx, int argc, char** argv, csq_options* opts)
{
    (void)arg; (void)idx; (void)argc; (void)argv;
    opts->debug_lexer = 1;
    return 0;
}

static int handle_help(const char *arg, int idx, int argc, char** argv, csq_options* opts)
{
    (void)arg; (void)idx; (void)argc; (void)argv;
    printf("C² Project\n");
...
static int handle_debug_ast(const char *arg, int idx, int argc, char** argv, csq_options* opts)
{
    (void)arg; (void)idx; (void)argc; (void)argv;
    opts->debug_ast = 1;
    return 0;
...
static int handle_emit_asm(const char *arg, int idx, int argc, char** argv, csq_options* opts)
{
...
static int handle_output(const char *arg, int idx, int argc, char** argv, csq_options* opts)
{
...
static const option_entry options[] = {
    {"--debug-lexer", handle_debug_lexer, 0},

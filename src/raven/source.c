 ...
 * @details Reads the entire file into memory and initializes a source structure.
 ...
 */csq_source* source_load(const char* path) {
    ...
    src->path = path;
#if defined(__linux__) || defined(__unix__) || defined(__APPLE__) || defined(__Jadeite__)
